# ⚡ Ayanokoji System v3.0

> Продвинутый трекер тренировок и личного развития с Progressive Overload, достижениями и умными уведомлениями
...
### Изменение интервала напоминаний о воде

Отредактируйте `js/notifications.js`:

```javascript
function scheduleWaterReminder() {
  const interval = 1.5 * 60 * 60 * 1000; // 1.5 часа вместо 2
  // ...
}
```
...
**Тестов**: 34/34 ✅  
**Модулей**: 15  
**Строк кода**: ~3000+ (без index.html)
